    ...
    public static boolean updateScoreBoard(Player player) {
        ...
        if (!Settings.isWorldDisabled(player.getWorld().getName())
            ...
            if (!player.hasPermission("InfoBoard.View")
                    || !WorldGuard.boardsAllowedHere(player.getLocation()))
        	if (!player.hasPermission("InfoBoard.View"))
                ...
                if (player.getScoreboard().getObjective(DisplaySlot.SIDEBAR) == null)
                    ...
                    else if (Settings.doesGlobalHaveScoreBoard(InfoBoard
                            .getTimers().getPage()))
                        worldName = "global";
                    else
                        return false;
                    ...
                    HashMap<Integer, String> toAdd = getLines(InfoBoard
                            .getFileManager()
                            .getBoard()
                            .getStringList(
                                    "Info Board."
