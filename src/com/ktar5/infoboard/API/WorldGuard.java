...
//GTN replaced for (ProtectedRegion protectedRegion : regions.getApplicableRegions(loc)) inRegions.add(protectedRegion);
        for (ProtectedRegion protectedRegion : regions.getApplicableRegions(BukkitUtil.toVector(loc))) inRegions.add(protectedRegion);
